...
COS_API_KEY_ID="yNTiWG4KVHygTnfBdOtYG-61L1D9CZ7Yvi65ycWg_CZd"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/22ae167894ad4cd189a37bc305b251b8:85df281c-6403-4bad-a8b6-f260ecc7457e::"
...
@app.route('/')
def index():
    files = get_bucket_contents('assignment03')
